  ...
  mutate(
    ...
    educadtl32 = labelled(
      ...
      labels = c(
        ...
        "Undergraduate or equivalent" = 3,
        "Post-graduate Diplomas and Certificates" = 4,
        "Diplomas in higher education and other higher education qualifications" = 5,
        "Teaching qualifications for schools or further education" = 6,
        "A/AS Levels or equivalent" = 7,
        "GCSE - Grade A-C, Level 4-9" = 8,
        "GCSE - Grade D-G, Level 1-3" = 9,
        "Scottish Qualifications - SCE Higher" = 10,
        "Scottish Qualifications - Scottish Certificate Sixth Year Studies" = 11,
        "Scottish Qualifications - SCE Standard" = 12,
        "Scottish Qualifications - National 4 and 5" = 13,
        "Scottish Qualifications - National 2 and 3" = 14,
        "Irish Qualifications - Leaving Certificate" = 15,
        "Irish Qualifications - Junior Certificate grade A-C" = 16,
        "Irish Qualifications - Junior Certificate grade D and below" = 17,
        "Other academic qualifications (including overseas)" = 18,
    ...
    educvdtl32 = labelled(
      educvdtl32,
      labels = c(
        "Professional qualifications at degree level" = 1,
        "Nursing or other medical qualifications" = 2,
        "NVQ or SVQ - Level 4 or 5" = 3,
        "NVQ or SVQ -  Level 3" = 4,
        "NVQ or SVQ - Level 2" = 5,
        "NVQ or SVQ - Level 1" = 6,
        "GNVQ - GNVQ Advanced" = 7,
        "GNVQ - GNVQ Intermediate" = 8,
        "GNVQ - Level 3" = 9,
        "GNVQ - Level 2" = 10,
        "GNVQ - Level Foundation" = 11,
        "City & Guilds - advanced craft, Part III" = 12,
        "City & Guilds - craft, Part II" = 13,
        "City & Guilds - craft, Part I" = 14,
        "City & Guilds - Level 3" = 15,
        "City & Guilds - Level 2" = 16,
        "City & Guilds - Level 1" = 17,
        "RSA - Advanced Diploma" = 18,
        "RSA - Higher Diploma" = 19,
        "RSA - Diploma" = 20,
        "RSA - RSA Stage I, II,III" = 21,
        "BTEC - Higher Level BTEC" = 22,
        "BTEC - BTEC National" = 23,
        "BTEC - BTEC First" = 24,
        "SCOTVEC-  SCOTVEC National Certificate" = 25,
        "SCOTVEC-  SCOTVEC first or general diploma" = 26,
        "SCOTVEC - SCOTVEC general diploma" = 27,
        "SCOTVEC - SCOTVEC modules" = 28,
        "HND or HNC" = 29,
        "OND or ONCM" = 30,
        "Junior certificate" = 31,
        "Other vocational qualifications (including some overseas)" = 32,
        "None of these qualifications" = 33,
        "Item not applicable" = -1,
        "Script error/information lost" = -2,
        "Not asked at the fieldwork stage/participated/interviewed" = -3,
        "Don’t know/insufficient information" = -8,

...
derived_all <- set_variable_labels(
  ...
  lang = "Language spoken at home (age 14-17y)",
  ...
  educaim17 = "Current qualification studied level 3-category (age 17y)",
  ...
  educadtl32 = "Highest education detail - academic (age 32y)",
  educvdtl32 = "Highest education detail - vocational (age 32y)",
  educma = "Highest education level mother 3-category (CM age 14-17y)",
  educpa = "Highest education level father 3-category (CM age 14-17y)",
  ...
  inc25 = "Banded weekly income of cohort member and partner (pounds, age 25y)",
  inc32 = "Banded weekly income of cohort member and partner (pounds, age 32y)",
  incwhh14 = "Banded weekly parents' gross salary (pounds, CM age 14y)",
  incwhh15 = "Banded weekly parents' gross salary (pounds, CM age 15y)",
  incwhhcnt14 = "Weekly parents' gross salary (pounds, continuous, CM age 14y)",
  incwhhcnt15 = "Weekly parents' gross salary (pounds, continuous, CM age 15y)",
  incwhh16 = "Banded weekly parents' gross salary (pounds, CM age 16y)",
  incwhh17 = "Banded weekly parents' gross salary (pounds, CM age 17y)",
  ...
  ghq15 = "General Health Questionnaire (GHQ12) symptom count (age 15y)",
  ghq17 = "General Health Questionnaire (GHQ12) symptom count (age 17y)",
  ghq25 = "General Health Questionnaire (GHQ12) symptom count (age 25y)",
  ghq32 = "General Health Questionnaire (GHQ12) symptom count (age 32y)",
  ghqtl15 = "General Health Questionnaire (GHQ12) score (age 15y)",
  ghqtl17 = "General Health Questionnaire (GHQ12) score (age 17y)",
  ghqtl25 = "General Health Questionnaire (GHQ12) score (age 25y)",
  ghqtl32 = "General Health Questionnaire (GHQ12) score (age 32y)",
  ...
  wt0 = "Weight (kilograms, parent reported, age 0y)",
  wt25 = "Weight (kilograms, age 25y)",
  wt32 = "Weight (kilograms, age 32y)",
  ht25 = "Height (metres, age 25y)",
  ht32 = "Height (metres, age 32y)",
  ht25_32 = "Height (metres, age 25y or 32y)",
  bmi25 = "Body Mass Index (BMI) (age 25y)",
  bmi32 = "Body Mass Index (BMI) (age 32y)",
  ...
  alcfst = "First time reported having alcohol (age 14-32y)",
